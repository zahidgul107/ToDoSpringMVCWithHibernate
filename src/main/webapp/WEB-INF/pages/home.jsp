			...
			<div class="col-md-4">
				<div class="list-group">
					...
					<a href='<c:url value="/home"></c:url>'
						class="list-group-item list-group-item-action">All TODOS</a> <a
					...
					<form:form action="saveTodo" method="post" modelAttribute="todo">
						...
						<div class="form-group">
							...
							<form:textarea path="todoContent" cssClass="form-control"
								rows="7" placeholder="Enter your todo content" />

						</div>

						<div class="container">

							<button class="btn btn-outline-success float-right">Add
								Todo</button>
